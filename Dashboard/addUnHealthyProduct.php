<?php
require './Dashboard/addUnhealthyProductProcess,php';
?>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <title>Admin Add Unhealthy Product</title>
...
<body>
  ...
  <section>
    <div class="container" style="width: 600px;">
      <h1 class="mb-3">Add Unhealthy Products</h1>
      <form action="/addUnHealthyProduct" method="post">
      <div class="mb-3">
